...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_morph->setGeometry(QRect(20, 470, 81, 41));
        Canvas = new QGraphicsView(centralWidget);
        Canvas->setObjectName(QStringLiteral("Canvas"));
        Canvas->setGeometry(QRect(10, 10, 650, 400));
        btn_render = new QPushButton(centralWidget);
        btn_render->setObjectName(QStringLiteral("btn_render"));
        btn_render->setGeometry(QRect(20, 420, 81, 41));
        groupBox = new QGroupBox(centralWidget);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(110, 420, 281, 131));
        ...
        groupBox_3->setGeometry(QRect(400, 430, 111, 61));
        ...
        groupBox_4->setGeometry(QRect(540, 420, 81, 101));
        ...
        progressBar->setGeometry(QRect(400, 500, 118, 21));
        progressBar->setValue(0);
        progressBar->setOrientation(Qt::Horizontal);
        label_4 = new QLabel(centralWidget);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(400, 530, 111, 16));
        spb_speed = new QSpinBox(centralWidget);
        spb_speed->setObjectName(QStringLiteral("spb_speed"));
        spb_speed->setGeometry(QRect(510, 530, 42, 22));
